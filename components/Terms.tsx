        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              Site, in which users can find general information about our
              browser extension. The terms “we,” “us,” and “our” refer to the
              Company. “You” refers to you, as a user of our Site or our
              Service.
            </p>
            <p
              className="text-xl text-gray-600 mb-8"
            ...
            >
              ...
              the Service, you signify your agreement to these Terms of Use.
              <strong>
                {" "}
            ...
            >
              ...
              that pertains to your privacy. When you access or use the Service,
              you signify your agreement to the Privacy Policy as well as these
              Terms of Use.
            </p>
            ...
            <p
              ...
              data-aos-delay="150"
            >
              The Service allows you to explore and find general information
              about the browser extension GSuiteDM.
            </p>
            ...
            <p
              ...
              data-aos-delay="150"
            >
              You need to be at least 13 years old and a resident of the United
              States to register for and use the Service. If you are a user who
              signs up for the Service, you will create a personalized account
              which includes a unique username and a password to access the
              Service and to receive messages from the Company. You agree to
            ...
            >
              ...
              provide bug reports and overall improvements (“User Content”) to
              the Service. You are solely responsible for the User Content that
              you post, upload, link to or otherwise make available via the
              Service.
            </p>
            <p
              className="text-xl text-gray-600 mb-8"
            ...
            >
              ...
              online distribution and publication of your User Content. The
              Company, however, reserves the right to remove any User Content
            ...
            <p
              ...
              data-aos-delay="150"
            >
              We grant you permission to use and access the Service, subject to
              the following express conditions surrounding User Content. You
              agree that failure to adhere to any of these conditions
            ...
            <p
              ...
              data-aos-delay="150"
            >
              The Site does not, and cannot, pre-screen or monitor all User
              Content. However, at our discretion, we, or technology we employ,
              may monitor and/or record your interactions with the Service or
              with other Users.
            </p>
            ...
            >
              ...
              the Site, are those of their respective authors, and should not
            ...
            >
              ...
              any information on the Site or the Service nor do we adopt nor
              endorse, nor are we responsible for, the accuracy or reliability
              of any opinion, advice, or statement made by other parties. We
              take no responsibility and assume no liability for any User
              Content that you or any other user or third party posts or sends
              via the Service. Under no circumstances will we be responsible for
              any loss or damage resulting from anyone&apos;s reliance on
              information or other content posted on the Service, or transmitted
              to users.
            </p>
            <p
              className="text-xl text-gray-600 mb-8"
            ...
            >
              ...
              of the Site or the Service or to limit or deny a user&apos;s
              access to the Service or take other appropriate action if a user
              violates these Terms of Use or engages in any activity that
              violates the rights of any person or entity or which we deem
              unlawful, offensive, abusive, harmful or malicious. E-mails sent
              between you and other participants that are not readily accessible
              to the general public will be treated by us as private to the
              extent required by applicable law. The Company shall have the
              right to remove any material that in its sole opinion violates, or
              is alleged to violate, the law or this agreement or which might be
              ...
              and/or civil prosecution under Federal, State and local law. If
              you become aware of a misuse of our Service or violation of these
            ...
            <p
              ...
              data-aos-delay="150"
            >
              As part of the Service, we may provide you with convenient links
              ...
              provided as a courtesy to Service subscribers. We have no control
              over Third Party Sites or Third Party Applications, Software or
              Content or the promotions, materials, information, goods or
              ...
              or completeness, and we are not responsible for any Third Party
              ...
              the Site, including the content, accuracy, offensiveness,
              opinions, reliability, privacy practices or other policies of or
              contained in the Third Party Sites or the Third Party
              ...
              approval or endorsement. If you decide to leave the Site and
              ...
              practices, of any Third Party Site to which you navigate from the
            ...
            >
              ...
              intellectual property rights of others and require that the users
              do the same. Pursuant to 17 U.S.C. 512(i) of the United States
              Copyright Act, we have adopted and implemented a policy that
              provides for the termination in appropriate circumstances of users
              of the Service who are repeat infringers. We may terminate access
              for participants or users who are found repeatedly to provide or
              post protected third party content without necessary rights and
              permissions.
            </p>
            <p
              className="text-xl text-gray-600 mb-8"
            ...
            >
              ...
              provided on the Service infringe upon your copyrights, you may
            ...
            >
              ...
              party informing such person that it may reinstate the removed
              content in ten (10) business days. Unless the copyright owner
              files an action seeking a court order against the content
            ...
            >
              ...
              and you represent and warrant that you have a right to grant, to
              the Company a royalty-free, sublicensable, transferable,
              ...
              voice, and/or likeness as contained in your User Content, if
              applicable, in whole or in part, and in any form, media or
            ...
            <p
              ...
              data-aos-delay="150"
            >
              Communications made through the Service&apos;s email and messaging
              system will not constitute legal notice to the Site, the Service,
              or any of its officers, employees, agents or representatives in
              any situation where legal notice is required by contract or any
              law or regulation.
            </p>
            ...
            >
              ...
              communications from us in an electronic form via the email address
              you have submitted; and (b) agree that all Terms of Use,
              ...
              such communications would satisfy if it were in writing. The
            ...
            >
              ...
              settings, using the “Unsubscribe” link in the message, or by
              sending an email to{" "}
              <a
                href="mailto:support@gsuitedm.com"
                className="text-blue-700 underline"
            ...
            >
              ...
              Site, the Service or special offers.
            </p>
            ...
            >
              ...
              FOREGOING, WE MAKE NO WARRANTY OR REPRESENTATION THAT ACCESS TO OR
            ...
            >
              ...
              FROM: (A) THE USE, DISCLOSURE, OR DISPLAY OF YOUR USER CONTENT;
              (B) YOUR USE OR INABILITY TO USE THE SERVICE; (C) THE SERVICE
              GENERALLY OR THE SOFTWARE OR SYSTEMS THAT MAKE THE SERVICE
              AVAILABLE; OR (D) ANY OTHER INTERACTIONS WITH USE OR WITH ANY
              ...
              ITS ESSENTIAL PURPOSE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT
            ...
            >
              ...
              merchant of a product or service that you review using the
              Service, you release us (and our officers, directors, agents,
              subsidiaries, joint ventures and employees) from claims, demands
            ...
            >
              ...
              responsibility to check the Site from time to time to view any
              such changes in this agreement. Your continued use of the Site or
              the Service signifies your agreement to our revisions to these
              Terms of Use. We will endeavor to notify you of material changes
              to the Terms by posting a notice on our homepage and/or sending an
              email to the email address you provided to us upon registration.
              For this additional reason, you should keep your contact and
              profile information current. Any changes to these Terms (other
              than as set forth in this paragraph) or waiver of our rights
              hereunder shall not be valid or effective except in a written
              agreement bearing the physical signature of one of our officers.
              No purported waiver or modification of this agreement on our part
            ...
            >
              ...
              such provision. Our rights under this agreement survive any
            ...
            >
              ...
              State of Rhode Island, without regard to conflict of law
              provisions.
            </p>
            <p
              className="text-xl text-gray-600 mb-8"
              ...
              data-aos-delay="150"
            >
              We may assign or delegate these Terms of Service and/or our
          ...
          {/* Download terms of use as PDF button */}
          <div className="flex items-center justify-center">
            <a
              href="/images/pdfs/TermsOfUse.pdf"
              download={true}
              className="button"
            >
