        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p
              ...
              data-aos-delay="150"
            >
              GSuiteDM (the “Company”) is committed to maintaining robust
              privacy protections for its users. Our Privacy Policy (“Privacy
              Policy”) is designed to help you understand how we collect, use
              and safeguard the information you provide to us and to assist you
            ...
            >
              ...
              in which users can find general information, contact the developer
              in the case of bugs, and follow a guided tutorial.
              <br />
            ...
            >
              ...
              <strong>Non-Personal Information</strong> includes information
              that cannot be used to personally identify you, such as anonymous
              ...
              email, username, and contact information, which you submit to us
            ...
            >
              ...
              Information,which may include: email address, username, and
              contact information. However, in an effort to improve the quality
              of the Service, we track information provided to us by your
              ...
              use cookies to collect the following information:
            </p>
            ...
            >
              ...
              your browser. For example, we store a persistent cookie to track
            ...
            >
              ...
              wish to receive marketing communications from us by not filling in
              the newsletter application located at the bottom of the Site.
              Please note that notwithstanding the promotional preferences you
              indicate by either unsubscribing or opting out in the bottom of
          ...
          <div className="flex items-center justify-center">
            <a
              href="/images/pdfs/PrivacyPolicy.pdf"
              download={true}
              className="button"
            >
