  ...
  return (
    <footer className="footer container container-narrow">
      ...
      <div className="row footer-brand">
        <div className="col">
          <a href="#" className="footer-logo" title="Briskine">
            <svg
              width="245"
              height="45"
              version="1.1"
        ...
        {/* Copyright */}
        <div className="col footer-brand-text text-end">© 2023 Briskine</div>
      </div>
    </footer>
  );
};
