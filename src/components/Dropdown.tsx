...
export default function Dropdown({ children, title }: DropdownProps) {
  ...
  return (
    ...
    >
      <a href="#" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out" aria-expanded={dropdownOpen} onClick={(e) => e.preventDefault()}>
        {title}
