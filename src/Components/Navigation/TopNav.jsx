      ...
      <div className="container">
        <nav className="navbar navbar-light navbar-expand-lg navbar-header">
          <div className="container-fluid p-0">
            <a href="https://www.briskine.com/" class="navbar-brand" aria-label="Home">
            ...
            <div className="navbar-collapse collapse show" id="navbarContent">
              <ul className="navbar-nav me-auto">
                ...
                <li className="nav-item dropdown dropdown-nav">
                  <a href="#" className="nav-link dropdown-toggle" id="useCasesDropdown">
                    Use Cases
                  </a>

                  <div class="dropdown-menu" aria-labelledby="useCasesDropdown">
                    <a class="dropdown-item" href="https://www.briskine.com/gmail-templates/">
                      {/* <img src="./website_files/icon-gmail.svg" class="dropdown-icon" aria-hidden="true"> */}
                      Templates for Gmail
                    </a>
                    <a class="dropdown-item" href="https://www.briskine.com/linkedin-templates/">
                      {/* <img src="./website_files/icon-linkedin-color.svg" class="dropdown-icon" aria-hidden="true"> */}
                      Templates for LinkedIn
                    </a>
                    <a class="dropdown-item" href="https://www.briskine.com/outlook-templates/">
                      {/* <img src="./website_files/icon-outlook.svg" class="dropdown-icon" aria-hidden="true"> */}
